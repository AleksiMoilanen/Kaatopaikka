...
rsync --rsh="sshpass -p $2 ssh -p $4 -o StrictHostKeyChecking=no" -avz $1@$3:/lib sysroot
rsync --rsh="sshpass -p $2 ssh -p $4 -o StrictHostKeyChecking=no" -avz $1@$3:/usr/include sysroot/usr
rsync --rsh="sshpass -p $2 ssh -p $4 -o StrictHostKeyChecking=no" -avz $1@$3:/usr/lib sysroot/usr ; exit 0
rsync --rsh="sshpass -p $2 ssh -p $4 -o StrictHostKeyChecking=no" -avz $1@$3:/opt/vc sysroot/opt